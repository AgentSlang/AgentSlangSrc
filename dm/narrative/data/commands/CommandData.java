...
package org.agent.slang.dm.narrative.data.commands;
...
/**
 * A data type stores CommandData type characteristics.
...
@TypeIdentification(typeID = 8)
public class CommandData implements GenericData {
    ...
    public CommandData(long id, List<String> data) {
        this.data = data;
        this.id = id;
    }
