...
package org.agent.slang.feedback;

import org.agent.slang.data.annotation.GenericTextAnnotation;
import org.agent.slang.data.simple.ValenceData;
 ...
 * @version 1, 12/21/12
 */
@ConfigureParams(outputChannels = "valence.data", outputDataTypes = ValenceData.class,
        inputDataTypes = GenericTextAnnotation.class)
public class ValenceExctractorComponent extends MixedComponent {
    private static final String outChannel = "valence.data";

    public ValenceExctractorComponent(String outboundPort, ComponentConfig config) {
    ...
    protected void handleData(GenericData data) {
        ...
        assert data instanceof GenericTextAnnotation;
    ...
    public void definePublishedData() {
        addOutboundTypeChecker(outChannel, ValenceData.class);
    }
}
